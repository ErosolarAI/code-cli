...
TodoWrite({
  todos: [
    {
      content: 'Analyze code complexity',
      status: 'in_progress',
      activeForm: 'Analyzing code complexity',
    },
    {
      content: 'Run parallel tests',
      status: 'pending',
      activeForm: 'Running parallel tests',
    },
    {
      content: 'Generate optimization report',
      status: 'pending',
      activeForm: 'Generating optimization report',
    },
  ],
});
```
