...
export class UnifiedUIController extends EventEmitter {
  ...
  private feedbackRegion: OverlayRegion | null = null;
  ...
  private updateOverlay(): void {
    ...
    // Feedback region (for plan/timeline summaries)
    if (this.feedbackRegion) {
      regions['feedback'] = this.feedbackRegion;
    }
  ...
  /**
   * Show a compact feedback overlay.
   */
  showFeedbackOverlay(content: string): void {
    this.feedbackRegion = {
      content,
